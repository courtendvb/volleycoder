...
{skill:"S",level:3, compound:true,
  ...
  {skill:"S",level:4,
   ...
   scene:{
     ...
     ball:[{fx:245,fy:222,tx:150,ty:34,curve:true},{fx:150,fy:34,tx:150,ty:98}],
  ...
  {skill:"S",level:4,
   ...
   scene:{
     ...
     ball:[{fx:150,fy:222,tx:230,ty:34,curve:true},{fx:230,fy:34,tx:150,ty:98}],
     actors:[{n:"A",side:"home",x:150,y:220,jump:true},{n:"B",side:"away",x:230,y:34}],
     hlHome:[6],hlAway:[5],result:"good",
   },
  ...
  {skill:"S",level:5,
   ...
   scene:{
     ...
     ball:[{fx:245,fy:220,tx:150,ty:34},{fx:150,fy:34,tx:70,ty:130}],
     actors:[{n:"A",side:"home",x:245,y:218,jump:true},{n:"B",side:"away",x:150,y:34},{n:"C",side:"away",x:70,y:94,jump:true},{n:"D",side:"home",x:70,y:130,jump:true}],
     hlHome:[1,4],hlAway:[6,2],result:"bad",
   },
  ...
  {skill:"S",level:5,
   ...
   scene:{
     ...
     ball:[{fx:55,fy:220,tx:70,ty:34,curve:true},{fx:70,fy:34,tx:70,ty:130}],
     actors:[{n:"A",side:"home",x:55,y:218,jump:true},{n:"B",side:"away",x:70,y:34},{n:"C",side:"away",x:230,y:94,jump:true},{n:"D",side:"home",x:70,y:130,jump:true}],
     hlHome:[5,4],hlAway:[1,4],result:"bad",
   },
  ...
  {skill:"S",level:5,
   ...
   scene:{
     ...
     ball:[{fx:150,fy:220,tx:230,ty:34,curve:true},{fx:230,fy:34,tx:150,ty:130}],
     actors:[{n:"A",side:"home",x:150,y:218,jump:true},{n:"B",side:"away",x:230,y:34},{n:"C",side:"away",x:150,y:66,jump:true},{n:"D",side:"home",x:150,y:130,jump:true}],
     hlHome:[6,3],hlAway:[5,8],result:"ace",
   },
  ...
  {skill:"R",level:5,
   ...
   scene:{
     ...
     ball:[{fx:55,fy:15,tx:150,ty:195},{fx:150,fy:195,tx:230,ty:66}],
     actors:[{n:"A",side:"away",x:55,y:18,jump:true},{n:"B",side:"home",x:150,y:193},{n:"C",side:"home",x:70,y:126,jump:true},{n:"D",side:"away",x:230,y:66,jump:true}],
     hlHome:[6,4],hlAway:[7],result:"bad",
   },
  ...
  {skill:"R",level:5,
   ...
   scene:{
     ...
     ball:[{fx:245,fy:15,tx:55,ty:195},{fx:55,fy:195,tx:55,ty:66}],
     ...
     hlHome:[5,3],hlAway:[9],result:"good",
   },
  ...
  {skill:"A",level:5,
   ...
   scene:{
     ...
     ball:[{fx:150,fy:220,tx:245,ty:60},{fx:245,fy:60,tx:70,ty:130}],
     ...
     hlHome:[6,4],hlAway:[7,4],result:"bad",
   },
  ...
  {skill:"D",level:5,
   ...
   scene:{
     ...
     ball:[{fx:150,fy:15,tx:150,ty:162},{fx:150,fy:162,tx:230,ty:98}],
     actors:[{n:"A",side:"away",x:150,y:18,jump:true},{n:"B",side:"home",x:150,y:162},{n:"C",side:"home",x:70,y:126,jump:true},{n:"D",side:"away",x:230,y:98}],
     hlHome:[8,4],hlAway:[4],result:"good",
   },
  ...
  {skill:"B",level:5,
   ...
   scene:{
     ...
     ball:[{fx:55,fy:15,tx:150,ty:195},{fx:150,fy:195,tx:70,ty:98}],
     ...
     hlHome:[6,3],hlAway:[2],result:"bad",
   },
