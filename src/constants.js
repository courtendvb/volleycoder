...
export const TUTORIAL_SLIDES = [
  {
    ...
    body: "バレーボールの各プレーを、短いコードで記録する世界標準の入力方式です。\n最初からすべてのコードを完璧に入力する必要はありません。DataVolley記法は、自分のレベルに合わせて情報量をコントロールできるのが大きな特徴です。最初は基本プレーだけを記録し、慣れてきたら「アタックのコース」など、より詳細な情報を付け足していくことができます。\nVolleyCoderでは、あなたのスキルに合わせてコード入力を基礎から無理なく練習できます。まずはシンプルな入力から始め、少しずつステップアップしていきましょう！",
    example: null,
    note: null,
  },
  {
